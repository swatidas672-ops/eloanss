  ...
  return (
    <div className="group relative rounded-2xl overflow-hidden bg-white dark:bg-[#0A192B]/70 border border-slate-200/90 dark:border-[#64B4FF]/15 hover:border-cyan-400 dark:hover:border-[#22D3EE]/50 shadow-xs dark:shadow-none transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl dark:hover:shadow-[0_15px_40px_-10px_rgba(34,211,238,0.25)] flex flex-col h-full text-slate-800 dark:text-[#E6F1FF]">
      ...
      <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-900">
        ...
        <div className="absolute bottom-3 right-4 px-3 py-1 rounded-lg bg-white/90 dark:bg-[#06111F]/80 border border-slate-200 dark:border-emerald-400/30 backdrop-blur-md text-xs font-mono font-bold text-emerald-700 dark:text-emerald-300 shadow-md flex items-center gap-1.5">
      ...
      <div className="p-6 flex flex-col flex-grow justify-between relative z-10">
        <div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors duration-300 font-display">
            {product.name}
          </h3>
          <p className="text-xs font-semibold text-cyan-600 dark:text-cyan-400/90 mt-1 uppercase tracking-wider">
            {product.tagline}
          </p>
          <p className="text-sm text-slate-600 dark:text-[#A9BDD1] mt-3 line-clamp-2 leading-relaxed">
            {product.shortDesc}
          </p>

          {/* Key coverage info */}
          <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-800/80 space-y-1.5 text-xs text-slate-600 dark:text-slate-300">
