  ...
  return (
    <div className="group relative rounded-2xl overflow-hidden bg-white dark:bg-[#0A192B]/70 border border-slate-200/90 dark:border-[#64B4FF]/15 hover:border-sky-400 dark:hover:border-[#0EA5FF]/50 shadow-xs dark:shadow-none transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl dark:hover:shadow-[0_15px_40px_-10px_rgba(14,165,255,0.3)] flex flex-col h-full text-slate-800 dark:text-[#E6F1FF]">
      ...
      <div className="relative h-52 w-full overflow-hidden bg-slate-100 dark:bg-slate-900">
        ...
        {/* Floating Rate Tag */}
        <div className="absolute bottom-3 right-4 px-3 py-1 rounded-lg bg-white/90 dark:bg-[#06111F]/80 border border-slate-200 dark:border-cyan-400/30 backdrop-blur-md text-xs font-mono font-bold text-sky-700 dark:text-cyan-300 shadow-md">
      ...
      <div className="p-6 flex flex-col flex-grow justify-between relative z-10">
        <div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-sky-600 dark:group-hover:text-cyan-300 transition-colors duration-300 font-display">
            {product.name}
          </h3>
          ...
          {/* Quick Metrics */}
          <div className="mt-5 grid grid-cols-2 gap-2 pt-4 border-t border-slate-200 dark:border-slate-800/80 text-xs">
